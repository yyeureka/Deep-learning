...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.hiddenUnit = nn.Linear(input_size + hidden_size, hidden_size)
        self.outputUnit = nn.Linear(input_size + hidden_size, output_size)
        self.tanh = nn.Tanh()
    ...
    def forward(self, input, hidden):
        ...
        hidden = self.tanh(self.hiddenUnit(tmp))
        output = self.logSoftmax(self.outputUnit(tmp))
